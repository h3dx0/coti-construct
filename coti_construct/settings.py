"""
Django settings for coti_construct project.
...
SECRET_KEY = 'az&%zg42!%(hd7)ni@#*#udg$#7o))m8=7d4)-dx^-1r9edx@m'
...
ROOT_URLCONF = 'coti_construct.urls'
...
WSGI_APPLICATION = 'coti_construct.wsgi.application'
